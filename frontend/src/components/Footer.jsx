  ...
  return (
    <footer className="footer">
      <div className="footerInner">
        ...
        <div className="footerCol">
          ...
          <ul className="footerLinkList">
            ...
            <li>
              <Link to="/service" className="footerLink">Services</Link>
            </li>
            <li>
        ...
        <div className="footerCol">
          ...
          <ul className="footerLinkList">
            <li>
              <Link to="/login" className="footerLink">Sign In</Link>
            </li>
            <li>
              <Link to="/register" className="footerLink">Create Account</Link>
            </li>
            <li>
              <Link to="/profile" className="footerLink">My Profile</Link>
            </li>
          </ul>
        </div>
        ...
        <div className="footerCol">
          ...
          <ul className="footerLinkList">
            ...
            <li>
              <a href="#" className="footerLink">Returns &amp; Refunds</a>
            </li>
            <li>
      ...
      <div className="footerBottom">
        <span className="footerCopy">&copy; {new Date().getFullYear()} MiniStore. All rights reserved.</span>
        <span className="footerMade">Made with ❤️ in India</span>
      </div>
    </footer>
  );
};
