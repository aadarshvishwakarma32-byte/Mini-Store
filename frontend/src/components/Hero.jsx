        ...
        <div className="heroVisual">
          <div className="heroFrame">
            ...
            <svg
              ...
              fill="none"
              role="img"
              aria-label="Summer collection shopping illustration"
            >
              <defs>
                <linearGradient
                  id="heroBag"
              ...
              <path
                d="M78 111c40-42 102-61 161-48 58 13 101 54 118 111"
                stroke="#6EE7B7"
                strokeWidth="2"
              ...
              />
              <path
                d="M143 158c0-38 16-61 39-61 24 0 39 23 39 61"
                stroke="#10B981"
                strokeWidth="7"
                strokeLinecap="round"
              />
              ...
              <path
                d="M208 226h24M220 214v24"
                stroke="#059669"
                strokeWidth="4"
                strokeLinecap="round"
              />
              <path
                d="M132 258h62M132 278h38"
                stroke="#6EE7B7"
                strokeWidth="5"
                strokeLinecap="round"
              />
              <path
                d="M264 258h28M264 278h20"
                stroke="#A7F3D0"
                strokeWidth="5"
                strokeLinecap="round"
              />
              <path
                d="M318 84l8 17 18 3-13 13 3 18-16-8-16 8 3-18-13-13 18-3 8-17Z"
                fill="#FDE68A"
              />
